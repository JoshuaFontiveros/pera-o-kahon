...
let epicFailSound = new Audio('./mp3/epic-fail-sound.mp3');
...
// Mega Jackpot is an equivalent of two prizes, which is One Million Pesos and House & Lot.
let prizes = [
  '₱1',
  '₱5',
  '₱10',
...
let consolationPrizeHouseAndLot = Math.floor(Math.random() * 15000 + 9000);
let consolationPrizeOneMillionPesos = Math.floor(Math.random() * 10000 + 9000);
let consolationPrizeIncrementor = Math.floor(Math.random() * 9000 + 8500);
...
for (let i = 0; i < boxColors.length; i++) {
  ...
  // CSS inside of function for code effiency
  function txtPrizeStyle() {
  ...
  function btnOpenStyleOpenCountThree() {
  ...
  function btnOpenStyleOpenCountGreaterThanEqualFour() {
    btnOpen.textContent = 'OPEN';
    btnOpen.style.backgroundColor = 'black';
    btnOpen.disabled = false;
  }

  function offerMoneyStyle() {
  ...
  function offerMoneyStyleBtnPera() {
    offerMoney.style.width = '100%';
    offerMoney.style.display = 'flex';
    offerMoney.style.justifyContent = 'center';
    offerMoney.style.alignItems = 'center';
  ...
  btnOpen.addEventListener('click', function () {
    ...
    if (openCount <= 3) {
      ...
      // starting offer
      txtPrize.style.display = 'none';
      btnOpenStyleOpenCountGreaterThanEqualFour();
      imgBox.setAttribute('src', './assets/box.png');
      ...
      btnKahon.addEventListener('click', function () {
        ...
        if (consolationPrizeCount < 100000 && prizes[i] === 'Mega Jackpot') {
          ...
          alert(
            `Dahil pinili mo ang kahon, heto na ang ₱${(consolationPrizeCount +=
              consolationPrizeMegaJackpot)}.\nKunin mo na to!`
          );
          hostQuestion.textContent = 'PERA O KAHON?';
          currentOffer.textContent = `CURRENT OFFER:`;
          offerMoney.textContent = `₱${consolationPrizeCount}`;
          ...
          consolationPrizeCount < 100000 &&
          prizes[i] === 'House & Lot'
        ) {
          chooseBtnClose.style.display = 'none';
          alert(
            `Dahil pinili mo ang kahon, heto na ang ₱${(consolationPrizeCount +=
              consolationPrizeHouseAndLot)}.\nKunin mo na to!`
          );
          offerMoney.textContent = `₱${consolationPrizeCount}`;
          openCount++;
          btnKahonCount++;
          ...
          peraKahonSound.play();
          offerMoneyStyle();
          hostQuestionAndCurrentOfferStyle();
        } else if (
          consolationPrizeCount < 100000 &&
          prizes[i] === 'One Million Pesos'
        ) {
          chooseBtnClose.style.display = 'none';
          alert(
            `Dahil pinili mo ang kahon, heto na ang ₱${(consolationPrizeCount +=
              consolationPrizeOneMillionPesos)}.\nKunin mo na to!`
          );
          offerMoney.textContent = `₱${consolationPrizeCount}`;
          peraKahonSound.currentTime = 0;
          peraKahonSound.play();
          ...
          consolationPrizeCount < 100000 &&
          (prizes[i] !== 'One Million Pesos' || 'Mega Jackpot' || 'House & Lot')
        ) {
          chooseBtnClose.style.display = 'none';
          openCount++;
          btnKahonCount++;
        ...
        if (
          consolationPrizeCount > 100000 &&
          consolationPrizeCount <= 200000 &&
          prizes[i] === 'Mega Jackpot'
        ) {
          chooseBtnClose.style.display = 'none';
          ...
          hostQuestion.textContent = 'PERA O KAHON?';
          offerMoney.textContent = `₱${(consolationPrizeCount += 250000)}`;
          ...
          currentOffer.textContent = 'LAST OFFER:';
          hostQuestion.textContent = 'PERA O KAHON?';
          offerMoney.textContent = `₱${(consolationPrizeCount += 200000)}`;
          twoHundredThousandMax.pause();
          twoHundredThousandMax.currentTime = 0;
          twoHundredThousandMax.play();
          offerMoneyStyle();
          ...
          currentOffer.textContent = 'LAST OFFER:';
          hostQuestion.textContent = 'PERA O KAHON?';
          offerMoney.textContent = `₱${(consolationPrizeCount += 150000)}`;
          twoHundredThousandMax.pause();
          twoHundredThousandMax.currentTime = 0;
          twoHundredThousandMax.play();
          offerMoneyStyle();
          ...
          consolationPrizeCount > 100000 &&
          consolationPrizeCount <= 200000 &&
          (prizes[i] !== 'Mega Jackpot' || 'One Million Pesos' || 'House & Lot')
        ) {
          chooseBtnClose.style.display = 'none';
          console.log(openCount);
          openCount++;
      ...
      btnPera.addEventListener('click', function () {
        ...
        confirmYesOrNoModalBg.classList.add(
          'btn-choose-bg',
          'btn-choose-bg-active'
        );
        ...
        btnConfirmYes.addEventListener('click', function () {
          if (
            ...
            txtPrizeStyleFinal();
            offerMoneyStyle();
            restartGameBtnInsideModal.style.display = 'inherit';
          } else {
            confirmYesOrNoModalBg.classList.remove('btn-choose-bg-active');
            confirmYesOrNoModal.classList.remove('btn-confirmation-modal');
            chooseBtnClose.style.display = 'none';
            chooseModal.style.width = 'auto';
            hostQuestion.style.display = 'none';
            currentOffer.style.display = 'none';
            offerMoney.style.textTransform = 'uppercase';
